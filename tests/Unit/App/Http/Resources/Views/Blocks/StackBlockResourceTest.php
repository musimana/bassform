...
test('getItem returns ok', function () {
    ...
    expect($actual)
        ...
        ->toHaveCount(1)
        ->toMatchArray([
            'html' => '<section id="stack"><h3 class="w-full mb-4 font-semibold text-sm text-gray-950 dark:text-gray-100 uppercase tracking-widest">Stack</h3><ul class="list-disc ml-8 mb-8">'
