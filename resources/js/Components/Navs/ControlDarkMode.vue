...
defineProps({
  customClasses: {
    type: String,
    default: 'w-8 h-8 flex m-auto border border-gray-900 dark:border-yellow-300 hover:border-gray-600 dark:hover:border-yellow-500 rounded-full cursor-pointer',
  },
})
</script>
...
<template>
  <UseDark v-slot="{ isDark, toggleDark }">
    <span :class="customClasses" @click="toggleDark()">
