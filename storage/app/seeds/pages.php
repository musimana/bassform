...
$seeds = [
    ...
    [
        ...
        'content' => '
            <p class="text-lg tracking-widest mb-8 border-l-4 border-gray-900 dark:border-gray-300 p-2 bg-gray-200 dark:bg-gray-800"><em>"Suped-up Laravel Breeze with Vue, Inertia & Tailwind"</em></p>
            <p class="px-4 pb-4">
